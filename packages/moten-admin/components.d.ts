...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    ConfigRadioGroup: typeof import('./src/components/config/config-radio-group.vue')['default']
    ...
    copy: typeof import('./src/components/config/config-input copy.vue')['default']
